<?php include_once "../conexion_botica.php"; ?>
<!Doctype html>
<html lang="es">
<head>
    <meta charset="utf-8">
...
<body>
    <!-- inicio  codigo php para la paginacion -->
    <?php
    ...
    $sentencia = $conexion_botica->query("SELECT * FROM Dim_Cliente c ORDER BY c.Cliente_Skey ASC
    OFFSET $empieza ROW FETCH NEXT $por_pagina ROW ONLY");

    //? Calcular el número total de páginas
    $sentencia_total = $conexion_botica->query("SELECT COUNT(*) FROM Dim_Cliente");
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="miNavbar">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="../registrar/registrar_cliente.php">Agregar [Cliente]</a>
                </li>
                <li class="nav-item">
        ...
        <form action="../buscar/buscar_cliente.php" method="get">
            ...
            <div class="col-12 padd">
                ...
                <div class="pagination">
                    <div class="pagination-content">
                        <?php if($pagina > 1):?>
                                <a class="star-end" href="listar_clientes.php?pagina=1">inicio</a>
                            <?php endif;?>
                            <button 
                            ...
                            <?php
                                ...
                                if ($i == $pagina) {
                                    echo "<a class='active btn-nav' href='listar_clientes.php?pagina=$i'>$i</a>";
                                } else {
                                    echo "<a class='btn-nav' href='listar_clientes.php?pagina=$i'>$i</a>";
                                }
                            }
                            ?>
                            <button 
                            ...
                            <?php if($pagina < $pagina_total): ?>
                                <a class="star-end" href="listar_clientes.php?pagina=<?php echo $pagina_total; ?> ">ultimo</a>
                            <?php endif; ?>
                    </div>
                </div>
                <script>
